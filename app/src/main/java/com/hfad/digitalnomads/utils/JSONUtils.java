    ...
    public static ArrayList<Notes> getNotesFromJSON(JSONObject jsonObject){
        ...
        try {
            ...
            String publishedAt = objectNotes.getString(KEY_PIBLISHED_AT); //получаем дату публикации
                ...
                Notes notes = new Notes(author, title, description, url, urlToImage, publishedAt); //добавляем в обьект автора, заголовок, описание, ссылку на статью. ссылку на картинку, дату публикации
